...
const Sidebar = ({ isSidebarOpen, closeSidebar }) => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 bg-gray-300 text-gray-800 w-64 h-screen p-4 flex flex-col justify-between z-40 transition-transform duration-300 ${
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li>
                            <Link
                                to="/dashboard"
                                className={`group flex items-center space-x-3 py-2 px-2 rounded transition-all duration-200 ${
                                    isActive("/dashboard")
